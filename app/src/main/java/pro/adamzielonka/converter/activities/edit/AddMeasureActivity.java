...
public class AddMeasureActivity extends ListActivity implements ListView.OnItemClickListener {
    ...
    public void onLoad() throws Exception {
        ...
        listView.addItemTitle(getString(R.string.list_add_measure));
        addByCreateView = listView.addItem(getString(R.string.list_item_create), getString(R.string.list_item_create_description));
        addFromFileView = listView.addItem(getString(R.string.list_item_load_from_json), getString(R.string.list_item_load_from_json_description));
        getFileView = listView.addItem(getString(R.string.list_item_json_repo), getString(R.string.list_item_json_repo_description));
        addFromCloudView = listView.addItem(getString(R.string.list_item_load_form_cloud), getString(R.string.list_item_load_form_cloud_description));
    }
